...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="SDE Feature Class" type="ArcSDE Connection" description="" format="" size="" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
